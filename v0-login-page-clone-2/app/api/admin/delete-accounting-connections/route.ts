...
/** DELETE all QBO and Xero connections (and their entities via CASCADE). For testing reconnect and sync. Auth: x-clean-db-secret. Production only. */
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    log("admin.delete-accounting-connections.done", { qboDeleted, xeroDeleted }, "db")
    return NextResponse.json({
      ok: true,
