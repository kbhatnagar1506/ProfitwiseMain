...
// Vendor detail endpoint - fetches complete vendor profile with transactions and Supermemory context
...
export async function GET(
  ...
  try {
    ...
    const entityType = (entity.entity_type as EntityType) || "vendor"
    ...
    try {
      ...
      console.warn(
        `[vendor-detail] Supermemory context fetch failed for ${entity.canonical_name}:`,
        err
      )
    }
