...
export const DEFAULT_FORECAST_CALIBRATION: ForecastCalibrationParams = {
  ...
  recurrence_confidence: {
    ...
    bill_soft_cap: 0.55, bill_soft_base: 0.8, bill_soft_floor: 0.15,
    bill_episodic_cap: 0.35, bill_episodic_base: 0.5, bill_episodic_floor: 0.1,
    unknown_cap: 0.15, unknown_base: 0.3,
    seasonal_cap: 0.85, seasonal_mult: 1.1,
    hard_cap: 0.95, hard_mult: 1.1,
    soft_cap: 0.80,
    episodic_cap: 0.50, episodic_mult: 0.7,
    fallback_cap: 0.30, fallback_base: 0.5,
    bill_only_base_conf: 0.12, bill_only_cv_mult: 0.8,
    bill_only_hard_cv: 0.2, bill_only_soft_cv: 0.5,
    bill_interval_soft_cap: 0.55, bill_interval_soft_base: 0.7,
    bill_interval_episodic_cap: 0.35, bill_interval_episodic_base: 0.5,
  },
